...
BASE_IMAGE_URL = "products/"

CATEGORY_IMAGES = {
    "Laptops": ["laptop.jpg", "laptop2.jpg", "laptop3.jpg", "laptop4.jpg", "laptop5.jpg", "laptop6.jpg"],
    "Desktops": ["desktop.jpg", "desktop2.jpg", "desktop3.jpg", "desktop4.jpg"],
    "Monitors": ["monitor1.jpg", "monitor2.jpg", "monitor3.jpg"],
    "Keyboards": ["keyboard1.jpg", "keyboard2.jpg", "keyboard3.jpg"],
    "Mice": ["mouse1.jpg", "mouse2.jpg"],
    "Networking": ["networking1.jpg", "networking2.jpg"],
    "Servers": ["server1.jpg", "server2.jpg"],
    "Storage Devices": ["storage1.jpg", "storage2.jpg", "storage3.jpg"],
    "Printers": ["printer1.jpg", "printer2.jpg"],
    "Software": ["software1.jpg", "software2.jpg"],
}
    ...
    def handle(self, *args, **kwargs):
        ...
        for product in products:
            ...
            if not available_images:
                continue  # Skip if no images available for category

            num_images = min(len(available_images), random.randint(1, 3))
            ...
            for i, image_file in enumerate(selected_images):
                ProductImage.objects.create(
                    product=product,
                    image=f"{BASE_IMAGE_URL}{image_file}",
